...
// import enterpriseSecurity from "";
import advancedAnalytics from "/adv.mp4";
...
export default function Landing() {
    const renderMedia = (feature: (typeof features)[0]) => {
        const isVideo =
            feature.image && (feature.image as string).endsWith(".mp4");
        const className =
            "h-48 w-full object-cover hover:scale-105 transition-transform duration-300";
